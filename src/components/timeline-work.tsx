    ...
    },
    {
      ...
      content: (
        <div className="rounded-lg  border-2 border-muted-foreground/50 p-4 shadow-md">
          ...
          <p className="mt-2 text-xs font-normal text-foreground md:text-sm">
            Greetings! I am a dedicated professional Front End Developer who
            crafts exceptional websites tailored to suit your business needs.
            With a strong foundation in the digital realm, I specialize in
            curating top-tier online platforms for a diverse range of
            industries. Whether you're the proprietor of a trendy fashion
            boutique or a dynamic player in the service sector, I offer the
