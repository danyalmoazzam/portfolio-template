...
const MainFooter = () => {
  ...
  const variants = {
    ...
    hidden: {
      ...
      opacity: 0,
      transition: {
        duration: 0.1, // Fast transition when hiding
      },
    },
  };
    ...
    <>
      ...
      >
        <div className="mx-auto  px-4 sm:container">
              ...
              <div className="md:w-99 pb-6 pt-2  ">
                ...
                <div className="  overflow-hidden rounded-full border-2  border-background  md:text-2xl">
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="hover:bg-primaryColor cols-span-1 group h-full w-full  cursor-pointer bg-white text-white duration-300 active:scale-95"
                    >
                      <svg
                        width="15"
                        height="15"
                        viewBox="0 0 15 15"
                        fill="none"
                        className="h-[80%] w-full transition-all duration-300  group-hover:translate-x-1"
          ...
          <div className="flex h-80 items-center justify-center border-y-2 border-gray-200 md:py-4">
            <LetterPullUp />
          </div>
