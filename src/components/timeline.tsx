    ...
    <div className="mb-32 w-full bg-background md:px-10" ref={containerRef}>
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        {data.map((item, index) => (
          <div key={index} className=" flex justify-start pt-10 md:gap-10">
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              ...
              <h3 className="hidden text-xl font-bold text-neutral-500 dark:text-neutral-400 md:block md:pl-20 md:text-5xl ">
                {item.title}
              </h3>
            </div>
        ...
        <div
          ...
          className="absolute left-8 top-0 w-[2px] overflow-y-hidden  bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-200 to-transparent to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] dark:via-neutral-700  md:left-8 "
        >
          <motion.div
            style={{
